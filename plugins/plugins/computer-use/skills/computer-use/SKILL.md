...
Do not spawn `nexts-computer-use.exe`, search for the helper executable, or build a custom helper protocol client. App approvals and user interruption handling only work through `scripts/computer-use-client.mjs`.
...
- Do not automate the Nexts desktop app UI or Nexts CLI or Nexts extensions within Windows apps
